        ...
        <div className="container">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-royal-500 mb-4">Pourquoi choisir Dubaï pour votre entreprise ?</h2>
            ...
            {/* KEY ADVANTAGES */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-royal-500 mb-4">Avantages clés pour les entreprises</h2>
              <ul className="space-y-6 text-grey-600">
                <li className="flex items-start gap-4">
                  <span className="text-2xl text-accent">💰</span>
                  <div>
                    <h3 className="font-semibold text-xl text-grey-900">Exemptions fiscales</h3>
                    <p>
                ...
                <li className="flex items-start gap-4">
                  <span className="text-2xl text-accent">🌐</span>
                  <div>
                    <h3 className="font-semibold text-xl text-grey-900">Propriété étrangère à 100 %</h3>
                    <p>
                ...
                <li className="flex items-start gap-4">
                  <span className="text-2xl text-accent">📍</span>
                  <div>
                    <h3 className="font-semibold text-xl text-grey-900">Position stratégique</h3>
                    <p>
                ...
                <li className="flex items-start gap-4">
                  <span className="text-2xl text-accent">🏢</span>
                  <div>
                    <h3 className="font-semibold text-xl text-grey-900">Infrastructures modernes</h3>
                    <p>
            ...
            {/* FREE ZONES */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-royal-500 mb-4">Les zones franches de Dubaï</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="card-premium">
                  <h3 className="font-bold text-xl mb-2 text-royal-500">Dubai Multi Commodities Centre (DMCC)</h3>
                  <p className="text-grey-600">Idéal pour le commerce, les matières premières, et les services financiers.</p>
                </div>
                <div className="card-premium">
                  <h3 className="font-bold text-xl mb-2 text-royal-500">Jebel Ali Free Zone (JAFZA)</h3>
                  <p className="text-grey-600">Parfait pour la logistique, le commerce, et l’industrie.</p>
                </div>
                <div className="card-premium">
                  <h3 className="font-bold text-xl mb-2 text-royal-500">Dubai Internet City (DIC)</h3>
                  <p className="text-grey-600">Conçu pour les entreprises technologiques et numériques.</p>
                </div>
                <div className="card-premium">
                  <h3 className="font-bold text-xl mb-2 text-royal-500">Dubai Media City (DMC)</h3>
                  <p className="text-grey-600">Dédié aux médias, à la publicité, et à la communication.</p>
                </div>
              </div>
            </section>
            ...
            {/* STEPS TO START */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-royal-500 mb-4">Comment démarrer une entreprise à Dubaï</h2>
              <p className="text-grey-600 leading-relaxed mb-4">
            ...
            {/* CONCLUSION */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-royal-500 mb-4">Votre succès à Dubaï avec Gresham Trust</h2>
              <p className="text-grey-600 leading-relaxed">
