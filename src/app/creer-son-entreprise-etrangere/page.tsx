        ...
        <div className="container">
          <div className="max-w-4xl mx-auto space-y-12 text-grey">
            ...
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Pourquoi créer une entreprise à l’étranger ?</h2>
            ...
            {/* KEY BENEFITS */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Avantages de l’internationalisation</h2>
              <ul className="space-y-6 text-grey">
                ...
                <li className="flex items-start gap-4">
                  <span className="text-2xl text-white">🔒</span>
                  <div>
                    <h3 className="font-semibold text-xl text-white">Confidentialité et protection des actifs</h3>
                    <p className="text-white">
                ...
                <li className="flex items-start gap-4">
                  <span className="text-2xl text-white">📈</span>
                  <div>
                    <h3 className="font-semibold text-xl text-white">Accès à de nouveaux marchés</h3>
                    <p className="text-white">
                ...
                <li className="flex items-start gap-4">
                  <span className="text-2xl text-white">⚖</span>
                  <div>
                    <h3 className="font-semibold text-xl text-white">Simplicité administrative</h3>
                    <p className="text-white">
            ...
            {/* STEPS TO CREATE */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Étapes pour créer une entreprise à l’étranger</h2>
            ...
            <section className="fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div className="card-premium">
                  ...
                  <p className="text-white">
                    Idéal pour les faibles taxes et l’accès au marché asiatique.
                  </p>
                </div>
                <div className="card-premium">
                  <h3 className="font-bold text-xl mb-2 text-marine-400">Dubaï</h3>
                  <p className="text-white">
                    Parfait pour les zones franches et l’exemption fiscale.
                  </p>
                </div>
                <div className="card-premium">
                  <h3 className="font-bold text-xl mb-2 text-marine-400">Singapour</h3>
                  <p className="text-white">
                    Reconnu pour son innovation et sa stabilité économique.
                  </p>
                </div>
                <div className="card-premium">
                  <h3 className="font-bold text-xl mb-2 text-marine-400">Luxembourg</h3>
                  <p className="text-white">
                    Favorisé pour les holdings et la gestion de patrimoine.
                  </p>
                </div>
              </div>
            </section>
