        ...
        <div className="container">
          <div className="max-w-4xl mx-auto space-y-12 text-grey">
            ...
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Pourquoi le Luxembourg est-il attractif pour les entreprises ?</h2>
            ...
            {/* CORPORATE TAX RATES */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Taux d&apos;imposition sur les sociétés</h2>
            ...
            {/* TAX TREATIES */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Traités fiscaux</h2>
              <p className="text-white leading-relaxed">
            ...
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Environnement économique</h2>
              <p className="text-white leading-relaxed">
            ...
            {/* SPECIAL TAX REGIMES */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Régimes fiscaux spéciaux</h2>
              <p className="text-white leading-relaxed">
            ...
            {/* CONCLUSION */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Optimisez votre fiscalité avec Gresham Trust</h2>
              <p className="text-white leading-relaxed">
