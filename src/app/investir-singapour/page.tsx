        ...
        <div className="container">
          <div className="max-w-4xl mx-auto space-y-12 text-grey">
            ...
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Pourquoi investir à Singapour ?</h2>
            ...
            {/* ECONOMIC STABILITY */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Stabilité économique</h2>
              <p className="text-white leading-relaxed">
            ...
            {/* INVESTMENT OPTIONS */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Options d’investissement</h2>
            ...
            {/* TAX INCENTIVES */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Avantages fiscaux</h2>
              <p className="text-white leading-relaxed">
            ...
            {/* STRATEGIC LOCATION */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Position stratégique</h2>
              <p className="text-white leading-relaxed">
            ...
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Résidence par investissement</h2>
              <p className="text-white leading-relaxed">
            ...
            {/* CONCLUSION */}
            <section className="fade-in">
              <h2 className="text-3xl font-semibold text-marine-400 mb-4">Maximisez vos investissements avec Gresham Trust</h2>
              <p className="text-white leading-relaxed">
